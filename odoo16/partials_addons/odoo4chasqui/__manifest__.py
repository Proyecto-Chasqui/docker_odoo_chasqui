{
    ...
    'depends': [
        ...
        'account_statement_import_base','account_statement_import_camt','account_statement_import_camt54','account_statement_import_ofx','account_statement_import_online','account_statement_import_online_paypal','account_statement_import_online_ponto','account_statement_import_sheet_file',
